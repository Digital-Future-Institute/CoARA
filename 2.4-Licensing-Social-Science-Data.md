...
This guide provides practical advice on licensing social science data, with particular attention to qualitative and mixed-methods research, and identifies repositories suitable for long-term preservation and sharing. For more information see [Opening up Qualitative Data](https://github.com/Digital-Future-Institute/CoARA/blob/main/1.7-Opening-up-Qualitative-Data.md)
...
Under the [**GDPR**](https://gdpr-info.eu/), personal data include any information relating to an identified or identifiable living person. Examples include:
