...
|-----------|-------------------|----------------------------------------|
| **Compliance** | Open access publishing, FAIR data management, open software, reproducibility practices, and funder or institutional requirements. | - Track compliance across projects, departments, or institutions.<br>- Identify areas of non-compliance early.<br>- Provide targeted support, guidance, and training.<br>- Promote a supportive approach that helps researchers meet requirements rather than imposing punitive controls. |
| **Evaluation** | Open research practices, diverse research outputs, and contributions beyond publications. | - Support Research Assessment Reform initiatives such as CoARA.<br>- Recognise datasets, software, engagement activities, and other non-traditional outputs.<br>- Integrate qualitative and contextual evidence into assessment processes.<br>- Promote more holistic, fair, and responsible approaches to evaluating research quality and impact. |
| **Trend Analysis** | Changes in Open Science adoption and research practices over time. | - Track growth in open access publishing.<br>- Monitor FAIR data adoption and repository use.<br>- Assess participation in citizen science and engagement activities.<br>- Measure progress towards strategic objectives.<br>- Identify emerging practices, opportunities, and gaps. |
| **Capacity Building and Incentives** | Researcher capabilities, support needs, infrastructure use, and engagement with Open Science practices. | - Identify training and development needs.<br>- Inform investment in infrastructure and support services.<br>- Develop incentives and recognition schemes for open practices.<br>- Provide tailored guidance to disciplines, departments, or career stages.<br>- Create a feedback loop that supports continuous improvement. |
| **Internal Learning and Improvement** | Institutional performance, policy implementation, and organisational change. | - Support strategic planning and policy development.<br>- Inform institutional evaluation and decision-making.<br>- Monitor progress against organisational goals.<br>- Encourage continuous learning and evidence-informed improvement rather than external competition or benchmarking. |
