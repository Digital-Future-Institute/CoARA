# Archiving and Processing Research Data
...
[**Open Science**](https://github.com/Digital-Future-Institute/CoARA/blob/main/1.-Introduction-to-Open-Science.md) is an approach to research that seeks to make knowledge creation more **transparent, accessible, reusable and trustworthy**. It encourages researchers to share not only publications, but also data, methods, software and documentation wherever possible.  
...
A [**Data Management Plan**](https://github.com/Digital-Future-Institute/CoARA/blob/main/4.-Introduction-to-Data-Management-Plans-(DMPs).md) explains how data will be handled during and after a project. Even where a DMP is not formally required, creating one helps structure good practice.  
...
- [The stated preservation commitment](https://github.com/Digital-Future-Institute/CoARA/blob/main/4.7-Supporting-Data-Archiving-and-Preservation-for-Data-Stewards-and-Librarians.md)  
- Availability of persistent identifiers (e.g. DOIs)  
- Metadata requirements  
- Access control options  
- [Licensing choices](https://github.com/Digital-Future-Institute/CoARA/blob/main/2.-Open-Licensing-in-Open-Science.md)  
