# Supporting Data Archiving and Preservation for Data Stewards and Librarians
 
> The following resources informed the development of this guide:
>
> - [UCL Research Data Management Archiving & Preservation](https://www.ucl.ac.uk/library/open-science-research-support/research-data-management/best-practices/how-guides/archiving)
> - [University of Cambridge Preservation and Archiving](https://www.data.cam.ac.uk/organising-storing/preservation-and-archiving)
> - [ICFA Recommendations for Best Practices for Data Preservation and Open Science in HEP](https://arxiv.org/abs/2508.18892)
>
...
**Source:** EOSC CZ Data Stewards Community: https://www.eosc.cz/en/communities/data-stewards
...
You are not enforcing compliance'you are **enabling good research practice by translating policy into action**.

The role of a data steward may include:

- Advising on [**Data Management Plans (DMPs)**](https://github.com/Digital-Future-Institute/CoARA/blob/main/4.-Introduction-to-Data-Management-Plans-(DMPs).md);
- Supporting compliance with legal, ethical, and regulatory requirements;
- Promoting [FAIR](https://github.com/Digital-Future-Institute/CoARA/blob/main/3.1.-Understanding-the-FAIR-Principles.md) data practices;
- Assisting with metadata creation and documentation;
- Supporting repository selection and data publication;
- Advising on [**data preservation and archiving**](https://github.com/Digital-Future-Institute/CoARA/blob/main/4.2-Research-Data-Retention-and-Preservation.md);
...
- Understanding copyright, [licensing](https://github.com/Digital-Future-Institute/CoARA/blob/main/2.-Open-Licensing-in-Open-Science.md), and [data sharing requirements](https://github.com/Digital-Future-Institute/CoARA/blob/main/1.6-Publishing-Open-Data.md);
- Developing [Data Management Plans](https://github.com/Digital-Future-Institute/CoARA/blob/main/4.-Introduction-to-Data-Management-Plans-(DMPs).md);
...
> Researcher: We don't know where to store our data yet.

**Response:**
> At this stage, it's useful to identify a suitable repository for your Data Management Plan. Depending on your discipline and funder, we can explore institutional, disciplinary, or generalist repositories together.
...
> Researcher: We're just saving everything on laptops.

**Response:**
> That's fine for working files, but you should also have backups in place. Ideally, data should be stored in at least two locations, such as secure university storage and a cloud or server system.
...
> Researcher: We don't have time to prepare data for archiving.

**Response:**
> We can prioritise the essential components' typically anonymised datasets, documentation, and key outputs. I can help you identify the minimum required set for deposit.
...
We must delete data after the project.  
Data can be retained long-term if properly justified and safeguarded.
...
> Researcher: We can't archive interviews because they contain personal data.

**Response:**
> You can still archive them using safeguards. For example, anonymised transcripts can be deposited in a controlled-access repository where access is managed rather than fully open.
...
> Researcher: Where should we deposit our data?

**Response:**
> It depends on your discipline and funder requirements. For example, social science data may go to UK Data Service, while other datasets may be better suited to institutional or generalist repositories.
...
> Researcher: We don't have documentation for our dataset.

**Response:**
> For archiving, we will need basic documentation so the data can be understood later. A simple README file explaining the structure, variables, and methodology is usually sufficient.
...
- Minimum: 5 to 10 years (varies by funder/institution)  
- Some datasets may require longer or indefinite preservation  

### Example interaction

> Researcher: Do we need to keep everything forever?

**Response:**
> No. Only data with long-term scientific, legal, or societal value need to be preserved. I can help you decide what should be retained for archiving.
...
> Researcher: If we upload data to a repository, is it safe forever?

**Response:**
> Repositories are designed for long-term preservation, including backups and migration planning. However, the data still needs to be properly prepared and documented to remain usable over time.

## Common Researcher Questions 

### Q1: Is data sharing mandatory?
> It depends on your funder and institution, but data should generally be shared where possible or made available under controlled access if sensitive.

### Q2: What if our data is sensitive?
> Sensitive data can still be archived using anonymisation, restricted access, or mediated access repositories.

### Q3: We don't have time to prepare data.
> We can prioritise the essential datasets and documentation needed for deposit to make the process manageable.

### Q4: Why is metadata necessary?
> Metadata ensures your data can be understood and reused in the future. Without it, datasets may become unusable even if preserved.

### Q5: Can we just use a shared drive?
> Shared drives are suitable for active work, but they do not provide long-term preservation or discovery functions. Repositories are needed for that.
...
- **Actian The Role of Data Stewards in Data Governance**: https://www.actian.com/blog/data-management/the-role-of-data-stewards-in-data-governance/
- **EOSC CZ Data Stewards Community**: https://www.eosc.cz/en/communities/data-stewards
- **OvalEdge Data Stewardship Guide: Roles, Responsibilities and Best Practices**: https://www.ovaledge.com/blog/data-stewardship-guide/
- **Princeton University Data Steward Roles and Responsibilities for Princeton**: https://cedar.princeton.edu/sites/g/files/toruqf1076/files/media/data_steward_roles_and_responsibilities_for_princeton.pdf
- **Journal of Biomedical Informatics Data Stewardship Roles and Competencies in Research Data Management**: https://www.sciencedirect.com/science/article/pii/S1532046423000588
- **University College London (UCL) Advanced Research Computing – Research Data Stewardship**: https://www.ucl.ac.uk/advanced-research-computing/vacancies/research-technology-professionals/research-data-stewardship
